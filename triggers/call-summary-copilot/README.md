...
Opens [GitHub Copilot CLI](https://docs.github.com/copilot/how-tos/use-copilot-agents/use-copilot-cli) in a terminal when Tuple Capture completes, to summarize the call.
